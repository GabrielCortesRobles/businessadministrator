...
class Reporte_PDF_ventahoy extends CI_Controller
{
	...
	{ 
		...
		$pdf->SetTitle('Reporte_PDF_ventahoy');
		...
		$res = $this->Model_ventasfecha->ventashoy();
		...
		ob_end_clean();
		$pdf -> Output('Reporte_PDF_ventahoy.pdf', 'I');  	
    }
}
?>
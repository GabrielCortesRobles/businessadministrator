...
class Reporte_PDF_ventaultimomes extends CI_Controller
{
	...
	{ 
		...
		$pdf->SetTitle('Reporte_PDF_ventafecha');
		...
		$res = $this->Model_ventasfecha->ultimomes();
		...
		ob_end_clean();
		$pdf -> Output('Reporte_PDF_ventaultimomes.pdf', 'I');  	
    }
}
?>
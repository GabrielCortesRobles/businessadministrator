...
class Reporte_PDF_ventafecha extends CI_Controller
{
	...
	{ 
		...
		$pdf->SetTitle('Reporte_PDF_ventasactuales');
		...
		$res = $this->Model_ventasfecha->buscarventas();
		...
		$pdf->cell(250,15,'REPORTE VENTAS DEL DÍA',0,1,'C');
		...
		ob_end_clean();
		$pdf -> Output('Reporte_PDF_ventafecha.pdf', 'I');  	
    }
}
?>